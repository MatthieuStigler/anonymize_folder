...
The simple function **ano()** will anonymise specified columns in a directory, using the *sha256* algorithm. It does:
 ...
 3. Use R digest::digest function, with algorithm *sha256*. NOTE: digest says *Please note that this package is not meant to be used for cryptographic purposes*.
